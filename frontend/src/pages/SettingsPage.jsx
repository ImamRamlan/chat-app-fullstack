...
const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen pt-20 h-screen flex items-center justify-center">
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-4 border-t border-base-300 bg-base-100">
                  <div className="flex gap-2">
                    <input
                      type="text"
                      className="input input-bordered w-full bg-base-200 focus:bg-base-200/50 focus:ring-0 focus:border-primary"
